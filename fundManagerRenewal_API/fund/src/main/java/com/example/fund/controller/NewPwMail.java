...
@Service
public class NewPwMail implements MailServiceInter {
    ...
    public MimeMessage creatMessage(String to) throws MessagingException, UnsupportedEncodingException {
        ...
        message.setSubject("[FundManager] 비밀번호 재발급입니다"); // 이메일 제목

        String msgg = "";
        msgg += "<h1>안녕하세요</h1>";
        msgg += "<h1>펀드 매니징 앱 FundManager 입니다</h1>";
        msgg += "<br>";
        msgg += "<p>아래 재발급된 비밀번호를 통해 새 비밀번호를 설정해주세요.</p>";
        msgg += "<br>";
        msgg += "<br>";
        msgg += "<div align='center' style='border:1px solid black'>";
        msgg += "<h3 style='color:blue'>재발급된 비밀번호입니다</h3>";
        ...
        message.setFrom(new InternetAddress("balamogoulish@naver.com", "FundManager_Admin"));
